  ...
  Areka: {
    ...
    fr: {
      ...
      paragraphs: [
        ...
        "À proximité, vous trouverez des restaurants, des supermarchés et des loueurs de vélos. Nous faisons confiance à nos hôtes pour faire preuve de bon sens en quittant notre maison, c'est pourquoi nous n'avons aucune règle de départ ni liste de contrôle au check-out.",
  ...
  Rana: {
    ...
    de: {
      ...
      paragraphs: [
        ...
        "Haben Sie einen besonderen Wunsch? Wir erfüllen ihn Ihnen gerne, wenn es möglich ist. Zögern Sie nicht, uns davon zu berichten.",
    ...
    he: {
      ...
      paragraphs: [
        ...
        "פוארטו ויחו הוא יעד מוכר היטב לתיירים מכל רחבי העולם. לעיירה חופים יפהפיים המוקפים ביער גשם טרופי עבות, והיא ביתם של שני פארקים לאומיים, מנסניו וקאוויטה. בלילה, פוארטו ויחו הופכת עם חיי לילה תוססים. שהות כאן מאפשרת לכם לחוות באופן מלא את כל מה שהופך את פוארטו ויחו למיוחדת.",
  ...
  Tucano: {
    ...
    hi: {
      ...
      paragraphs: [
        ...
        "यदि आपकी कोई विशेष अनुरोध है, तो जब भी संभव हो हमें उसे पूरा करके खुशी होगी, इसलिए हमें बताने में संकोच न करें। यदि आपको अपने ठहरने के लिए पैक-एंड-प्ले क्रिब (बच्चों के लिए पालना) चाहिए, तो कृपया हमें पहले से सूचित करें, और हम सफाई के दौरान इसे आपके कमरे में लगाना सुनिश्चित करेंगे।",
  ...
  VillaCoral: {
    ...
    it: {
      ...
      paragraphs: [
        ...
        "La villa, che vanta una piscina privata, cucina e bagno, è stata arredata dalla interior designer portoricana Lourdes Menéndez",
