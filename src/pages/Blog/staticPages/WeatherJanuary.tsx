...
const WeatherJanuary = () => (
    <MonthlyWeatherArticle month="january" routeKey="blogWeatherJan" slug="weather-puerto-viejo-january" heroImage={HERO_IMAGE} />
);

export default WeatherJanuary;
