...
const WeatherSeptember = () => (
    <MonthlyWeatherArticle month="september" routeKey="blogWeatherSep" slug="weather-puerto-viejo-september" heroImage={HERO_IMAGE} />
);

export default WeatherSeptember;
