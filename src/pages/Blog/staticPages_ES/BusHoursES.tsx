            ...
            <Row className="subContainer" style={{ justifyContent: 'center' }}>
                ...
                <Col className="info col" lg={{ order: 'first', span: 8 }} md={{ order: 'first', span: 10 }} sm={12} xs={12}>
                    ...
                    <div className="description" style={{ maxWidth: 1000, }}>
                        ...
                        <p>¿Necesitas información actualizada sobre horarios o rutas? Puedes contactar por WhatsApp la empresa de buses para obtener la información más reciente sobre los servicios de autobús:</p>
