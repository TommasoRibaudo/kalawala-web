    ...
    return (
        <div className={`listingContainer${show ? ' modal-open' : ''}`}>
            <Helmet>
                ...
                <link rel="canonical" href={`https://www.reservaskalawala.com/Areka${localeSuffix(locale)}`} />
            ...
            <Row className="subContainer">
                ...
                <Col id="smoobuComp" className="book col" lg={2} md={{ span: 12 }} sm={{ span: 12 }} xs={{ span: 12 }}>
                    ...
                    <BookingSearchWidget locale={locale} defaultGuests={houseData!.guestNumber} variant="sidebar" apartmentSlug="Areka" />
                </Col>
            </Row>
