...
const ListingTucano = () => {
    ...
    const m = useMessages();
    const content = listingContent('Tucano', locale);
    const listing = `Tucano${localeSuffix(locale)}`
            ...
            <Row className="subContainer">
                <Col className="info col" lg={{ order: 'first', span: 10 }} md={{ order: 'first', span: 12 }} sm={12} xs={12}>
                    <div className="heading">
                        ...
                        <ListingMarketingSection propertyKey="Tucano" locale={locale} />
                    </div>
                    <ImagesContainer showModal={handleShow} houseName={listing!} />
                    {/* Add social statement after images */}
                    <SocialStatement propertyKey="Tucano" locale={locale} />
                    <div className="amenaties">
                        <Amenities amenities={houseData?.amenities as AmenityType[]} propertyKey="Tucano" locale={locale} />
                    </div>
                   
                    {/* Add feature highlights before description */}
                    <FeatureHighlights propertyKey="Tucano" propertyName={content.featureName} locale={locale} />
                ...
                <Col id="smoobuComp" className="book col" lg={2} md={{ span: 12 }} sm={{ span: 12 }} xs={{ span: 12 }}>
                    <PriceConfirmationSection propertyKey="Tucano" locale={locale} />
                    <BookingSearchWidget ref={widgetRef} locale={locale} defaultGuests={houseData!.guestNumber} variant="sidebar" apartmentSlug="Tucano" />
                </Col>
            </Row>
