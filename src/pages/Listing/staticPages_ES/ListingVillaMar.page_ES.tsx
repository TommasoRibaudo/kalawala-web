...
import { homesSnippet, VillaSnippet, VillaMarSnippet } from "../../../utils/constants";
    ...
    return (
        <div className={`listingContainer ${show && 'modal-open'}`}>
            <Helmet>
                ...
                <link rel="canonical" href="https://www.reservaskalawala.com/VillaMarES" />
...
export default ListingVillaMarES;