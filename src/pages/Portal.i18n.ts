...
export const portalStrings = {
  en: {
    ...
    errorBookingNotConfirmed: 'This reservation is not yet confirmed. The portal is available once your booking is confirmed.',
  ...
  es: {
    ...
    errorBookingNotConfirmed: 'Esta reserva aún no está confirmada. El portal estará disponible una vez que se confirme tu reserva.',
